...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql_user = "INSERT INTO user(UserID, UserName, User_phone, UserAge, UserGender, UserHeight, currentweight, targetweight, password, User_healthgoal)
    ...
    <div class="container">
        ...
        <form action="register_user.php" method="POST"><br>
            <table>
                ...
                <tr><th>UserID :</th><td><input type="text" name="UserID" required></td></tr>
                <tr><th>Name :</th><td><input type="text" name="UserName" required></td></tr>
                <tr><th>Phone Number :</th><td><input type="text" name="User_phone" required></td></tr>
                <tr><th>Age :</th><td><input type="text" name="UserAge"></td></tr>
                <tr><th>Gender :</th><td><input type="text" name="UserGender" required></td></tr>
                <tr><th>Height in m:</th><td><input type="text" name="UserHeight" required></td></tr>
                <tr><th>Current Weight :</th><td><input type="text" name="currentweight" required></td></tr>
                <tr><th>Target Weight :</th><td><input type="text" name="targetweight"></td></tr>
                <tr><th>Password :</th><td><input type="password" name="password"></td></tr>
                <tr><th>Health Goal :</th><td><input type="text" name="User_healthgoal"></td></tr>
                <tr><th>Coach ID :</th><td><input type="text" name="CoachID"></td></tr>

                <tr><th colspan="2">Plan Info</th></tr>
                <tr><th>Plan Start Date:</th><td><input type="date" name="Plan_StartDate"></td></tr>
                <tr><th>Plan End Date:</th><td><input type="date" name="Plan_EndDate"></td></tr>

                <tr><th colspan="2">Diet Plan</th></tr>
                <tr><th>Diet ID :</th><td><input type="text" name="DietID"></td></tr>
                <tr><th>Diet Goal Type :</th><td><input type="text" name="diet_goaltype"></td></tr>
